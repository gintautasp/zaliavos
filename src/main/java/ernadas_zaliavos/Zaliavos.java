...
public class Zaliavos {
	...
	public Zaliavos(Integer id, String pav, Integer flag_skirtas_galutiniam_vartojimui, String vnt_mato, Double kiekis,
			Double kaina_uz_kiekio_vnt, String aprasymas) {
		// super();
		id = id;
		this.pav = pav;
	...
	public Zaliavos(String id, String pav, String flag_skirtas_galutiniam_vartojimui, String vnt_mato, String kiekis,
			String kaina_uz_kiekio_vnt, String aprasymas) {
		// super();
